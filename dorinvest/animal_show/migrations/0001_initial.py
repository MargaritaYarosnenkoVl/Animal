# Generated by Django 5.0.3 on 2024-04-11 20:34
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ended_show', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ended_show', to='animal_show.endedshow', verbose_name='Прошедшие выставки')),
                ('photoreport', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='photoreport', to='animal_show.photoreport', verbose_name='Фотоотчет с выставки')),
            ],
        ),
        migrations.CreateModel(
            name='Show',
